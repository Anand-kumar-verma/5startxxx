...
import { stargold, zubgback, zubgbackgrad, zubgmid } from '../../../Shared/color';
...
export const style = {
  ...
  paytmbtntwo: { borderRadius: '5px', textTransform: 'capitalize', mb: 2, background: stargold, color: 'white !important', width: '100%', mt: '20px', padding: '10px', '&:hover': { background: zubgbackgrad, border: "1px solid transparent", } },
