        ...
        <Box sx={style.notificationBox}>
          <Stack direction='row' sx={style.notificationStack}>
            <Stack direction='row' sx={style.notificationStack}>
              ...
              <Typography variant="body1" color="initial">Referral Income </Typography>
            </Stack>
          </Stack>
          <Typography variant="body1" color="initial" className='pt-5 !text-xl'> You will earn 10% on the first recharge of each referral account.</Typography>
        </Box>
      </Container>
    </Layout>
  );
...
export default ReferralIncomeRule;
