    ...
    >
      <Box sx={{}}>
        ...
        >
          ...
          >
            <div className="error text-center fp13">
              After sent OTP , Please do not refresh your page.
            </div>
            <div className=" text-center fp13" style={{ color: 'white', margin: '10px 0px', }}>
            ...
            >
              ...
              <div className="flex flex-col justify-center !mt-5">
                ...
                <p className="!text-sm text-right fp13" style={{ color: 'white', marginTop: '15px' }}>
                  <span
